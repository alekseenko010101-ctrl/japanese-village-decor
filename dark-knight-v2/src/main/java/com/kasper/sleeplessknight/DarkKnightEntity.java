...
public class DarkKnightEntity extends WitherSkeleton {
    public DarkKnightEntity(EntityType<? extends WitherSkeleton> type, Level level) {
        super(type, level);
    ...
    protected void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
        // The greatsword is built into the animated model.
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty,
        ...
        getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(30.0);
